...
Source0  : https://cpan.metacpan.org/authors/id/S/SK/SKONNO/Net-UPnP-1.4.4.tar.gz
...
tar -xf %{SOURCE1}
cd ..
%setup -q -n Net-UPnP-1.4.4
mkdir -p %{_topdir}/BUILD/Net-UPnP-1.4.4/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Net-UPnP-1.4.4/deblicense/
